          ...
          <div className="d-md-flex align-items-center h-md-100 justify-content-center">
            ...
            <Form className="" onSubmit={this.handleSubmit}>
              ...
              <Row style={{ marginTop: 10 }}>
                <Col>
                  <img src={logo} alt="arcelor logo" className="mx-auto d-block" style={{ width: '42%', marginLeft: '30px' }} />
                </Col>
              </Row>
              ...
              <Row style={{ marginTop: 10, textAlign: 'center' }}>
                <Col>
                  <div className="login-border-box">
                    ...
                    <div style={{ marginTop: '30px', fontSize: '17px' }}>
                      <small className="text-muted">
                        Popup blockers interfere with the operation of this application.Please disable your popup blocker.
                      </small>
                      <div style={{ marginTop: '30px' }}>
                        <small className="text-muted">Please click the 'Login' button to continue.</small>
                      </div>
                    </div>
                    <Button
                      loading={this.state.loading1}
                      onClick={this.azureSignIn}
                      style={{ color: 'white', marginTop: '50px', marginBottom: '50px', height: '65px', width: '215px', fontSize: '20px' }}
                      type="primary"
                    >
