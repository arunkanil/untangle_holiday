...
class CreateOrUpdateUser extends React.Component<ICreateOrUpdateUserProps> {
  ...
  render() {
    ...
    return (
      <Modal visible={visible} cancelText={L('Cancel')} okText={L('OK')} onCancel={onCancel} onOk={onCreate} title={'Change Roles'}>
        <Tabs defaultActiveKey={'userInfo'} size={'small'} tabBarGutter={64}>
          <TabPane tab={L('Roles')} key={'rol'}>
            <FormItem label={L('SelectedRoles')} {...tailFormItemLayout}>
